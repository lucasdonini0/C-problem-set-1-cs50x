...
int main(void)
{
    ...
    if (sum % 10 == 0)
    {
        ...
        else if (length == 16 && (input / 100000000000000 == 51 || input / 100000000000000 == 52 || input / 100000000000000 == 53 || input / 100000000000000 == 54 || input / 100000000000000 == 55 || input / 100000000000000 == 22))
            {
